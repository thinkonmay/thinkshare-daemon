...
$gstreamerdev.Downloadfile("https://gstreamer.freedesktop.org/data/pkg/windows/1.22.3/mingw/gstreamer-1.0-devel-mingw-x86_64-1.22.3.msi"                                               ,"msi/gstreamer-dev.msi")
$gstreamer = New-Object net.webclient
$gstreamer.Downloadfile("https://gstreamer.freedesktop.org/data/pkg/windows/1.22.3/mingw/gstreamer-1.0-mingw-x86_64-1.22.3.msi"                                                        ,"msi/gstreamer.msi")
